...
*/
var aa=__webpack_require__(5),ca=__webpack_require__(0),m=__webpack_require__(21),p=__webpack_require__(8),v=__webpack_require__(6),da=__webpack_require__(22),ea=__webpack_require__(23),fa=__webpack_require__(24),ha=__webpack_require__(11);
...
var _Products = __webpack_require__(71);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(PrivateRoute, { path: '/admin', component: Admin }),
...
var PrivateRoute = function PrivateRoute(_ref) {
  ...
  return _react2.default.createElement(_reactRouterDom.Route, {
    render: function render(props) {
      return _Login.fakeAuth.isAuthenticated === true ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouterDom.Redirect, { to: { pathname: '/login', state: { from: props.location } } });
    } });
};
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: match.url + '/footwear' },
          'Footwear'
        )
      )
    ),
    _react2.default.createElement(_reactRouterDom.Route, { path: match.path + '/:name', render: function render(_ref2) {
        var match = _ref2.match;
        return _react2.default.createElement(
          'div',
          null,
...
var Products = function Products(_ref) {
    ...
    var linkList = productsData.map(function (product) {
        return _react2.default.createElement(
            'li',
            { key: product.id },
            _react2.default.createElement(
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { path: match.url + '/:productId', render: function render(props) {
                return _react2.default.createElement(_Product2.default, _extends({ data: productsData }, props));
            } }),
...
var Product = function Product(_ref) {
  ...
  if (product) productData = _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: canonicalUrlLink } }),
    _react2.default.createElement(
      'h3',
      null,
      ' ',
  ...
  );else productData = _react2.default.createElement(
    'h2',
    null,
